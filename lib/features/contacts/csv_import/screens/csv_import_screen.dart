...
import 'package:autoreply/features/contacts/csv_import/services/csv_import_service.dart';
  ...
  Future<void> _pickCsvFile() async {
    try {
      ...
      if (result != null && result.files.single.path != null) {
        ...
        // Validate file
        final isValid = await CsvImportService.validateCsvFile(file);
        if (!isValid) {
          setState(() {
            _errorMessage =
                'Invalid CSV format. Please ensure file has Name and Phone columns.';
            _isLoading = false;
          });
          return;
        }
        ...
        // Parse and preview
        final contacts = await CsvImportService.importFromCsv(file);

        if (contacts.isEmpty) {
          setState(() {
            _errorMessage = 'No valid contacts found in CSV file.';
            _isLoading = false;
          });
          return;
        }
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Your CSV file can have:\n'
                    '• Name and Phone Number columns\n'
                    '• Only Phone Numbers (names auto-generated)\n'
                    '• Any format - we detect phone numbers automatically\n\n'
                    'Examples:\n'
