        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-6 text-md-start text-center mt-0">
              <p class="mb-0"><?php echo html_entity_decode(get_option('website_copyright', '© 2025-26 <a href="https://mqtechguru.com/" target="_blank" class="text-decoration-none">MQ TECH GURU</a> All Rights Reserved')); ?></p>
            </div>
          </div>
        </div>
      </div>
