<style type="text/css">
    ...
    .sp-opt-mini.sp-opt-show{
        display: block;
    }

    .sp-opt-mini .sp-opt-content{
        max-width: 400px;
    ...
    .sp-opt-mini .sp-opt-content .sp-opt-mini-title{
        font-size: 14px;
        font-weight: 600;
        margin-bottom: 5px;
    }

    .sp-opt-mini .sp-opt-content .sp-opt-mini-desc{
        font-size: 14px;
        margin-bottom: 20px;
    }

    .sp-opt-mini .sp-opt-content .sp-opt-mini-action{
        text-align: right;
    }

    .sp-opt-mini .sp-opt-content .sp-opt-mini-action .sp-opt-btn-allow{
        text-align: right;
        appearance: none;
    ...
    .sp-opt-mini .sp-opt-content .sp-opt-mini-action .sp-opt-btn-deny{
        text-align: right;
        appearance: none;
...
<div class="sp-opt-mini" id="sp-opt-main">
    <div class="sp-opt-content sp__animate__animated sp__animate__slideInDown">

        <div class="sp-opt-mini-title"><?php _ec($opt_options["opt_title"])?></div>
        <div class="sp-opt-mini-desc"><?php _ec($opt_options["opt_desc"])?></div>
