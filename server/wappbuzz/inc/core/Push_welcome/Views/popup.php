...
?>
<div class="modal fade aig-modal push-main" id="CreateNotificationModal" tabindex="-1" role="dialog">
  	<div class="modal-dialog modal-xl modal-dialog-centered">
	    <div class="modal-content">

      		<div class="modal-header">
		        <h5 class="modal-title d-flex justify-content-center align-items-center"><i class="<?php _ec( $config['icon'] )?> me-2" style="color: <?php _ec( $config['color'] )?>;"></i> <?php _e("Send Notification")?></h5>
		         <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	      	</div>
	      	<div class="modal-body shadow-none">

				<form class="actionForm" action="<?php _e( get_module_url("save") )?>" method="POST" data-redirect="" data-loading="true">
			        ...
			        <div class="row">
			            <div class="col-md-6">
			                <div class="card border mb-4 b-r-10">
			                    ...
			                    <div class="card-body">
			                    	<?php if ($post): ?>
			                    		<input type="text" name="id" class="form-control d-none" value="<?php _ec( $post->id )?>">
			                    	<?php endif ?>
			                    ...
			                    <div class="card-body">
			                        <div class="accordion" id="accordion_large_image">
			                            ...
			                            <div id="tab_large_image" class="accordion-collapse collapse <?php _e( $large_image_status?"show":"" )?> mb-3" aria-labelledby="headingOne" data-bs-parent="#accordion_large_image">
			                                <!-- <img src="<?php _ec( get_file_url(get_user("avatar")) )?>" class="img-thumbnail large_image mw-100 mb-3  w-150 h-150"> -->
			                ...
			                <div class="card mt-4 b-r-10">
			                    <div class="card-body p-15 border b-r-10">
			                        <div class="d-flex justify-content-end">
			                            <!-- <button class="btn btn-dark b-r-10"><i class="fad fa-eye"></i> <?php _e("Preview")?></button> -->
			                            ...
			                            <?php if (!$post): ?>
			                                ...
			                                ?>
			                                <div>
			                                    <button type="submit" href="#" class="btn btn-primary btnSchedulePost b-r-10 <?php _ec( $button == 1?"":"d-none" )?>">
			                                        <i class="fal fa-paper-plane"></i> <?php _e("Schedule")?>
			                                    </button>
			                                    <button type="submit" href="#" class="btn btn-primary btnSaveDraft b-r-10 <?php _ec( $button == 2?"":"d-none" )?>">
			                                        <i class="fad fa-save"></i> <?php _e("Save as Draft")?>
			                                    </button>
			                                </div>
			                            <?php else: ?>
			                                <button type="submit" href="#" class="btn btn-primary btnSchedulePost b-r-10">
			                                    <i class="fal fa-paper-plane"></i> <?php _e("Schedule")?>
			                                </button>
			                            <?php endif ?>
			                        </div>
