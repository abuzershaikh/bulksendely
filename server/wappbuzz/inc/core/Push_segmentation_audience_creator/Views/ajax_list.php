	...
	<?php foreach ($result as $key => $value): ?>
		...
		<tr class="item">
		    ...
		    <td class="border-bottom text-nowrap w-90">
		    	<a href="<?php _e( get_module_url('index/view/'.$value->ids) )?>" class="actionItem btn btn-success btn-sm px-2 py-1" data-result="html" data-content="main-wrapper" data-history="<?php _e( get_module_url('index/view/'.$value->ids) )?>">
		    		<i class="fad fa-eye p-0 fs-12"></i>
		    	</a>
		    	<a href="<?php _e( get_module_url('index/update/'.$value->ids) )?>" class="actionItem btn btn-sm px-2 py-1 btn-dark" data-result="html" data-content="main-wrapper" data-history="<?php _e( get_module_url('index/update/'.$value->ids) )?>">
