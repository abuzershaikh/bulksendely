<div class="container d-sm-flex align-items-md-center pt-4 align-items-center justify-content-center">
    <div class="bd-search position-relative me-auto">
        <h2 class="mb-0 py-4 text-gray-800"> <i class="<?php _ec( $config['icon'] )?> me-2" style="color: <?php _ec( $config['color'] )?>;"></i> <?php _e("Audience: ")?> <?php _ec( get_data($result, "name") )?></h2>
    </div>
    ...
    <div class="">
        <div class="dropdown me-2">
            <div class="input-group input-group-sm sp-input-group border b-r-4">
                ...
                <a href="<?php _ec( get_module_url("index/update/".$ids) )?>" class="btn btn-light btn-active-light-primary m-r-1 border-end" title="<?php _e("Edit")?>" data-toggle="tooltip" data-placement="top"><i class="fad fa-pencil-alt text-primary pe-0"></i></a>
                <a href="<?php _e( get_module_url() )?>" class="btn btn-light btn-active-light-success m-r-1" title="<?php _e("All Audience")?>" data-toggle="tooltip" data-placement="top"><i class="fad fa-th-list text-success pe-0"></i></a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="bg-white border p-30 b-r-10 mb-5">
        <div class="d-flex justify-content-between mb-2">
            <div class="me-2">
                ...
                <div class="fs-12 text-gray-600"><?php _e("The list of subscribers following your customized segmentation")?></div>
            </div>
