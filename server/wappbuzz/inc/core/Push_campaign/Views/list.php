    ...
    <div class="">
        <div class="dropdown me-2">
            <div class="input-group input-group-sm sp-input-group border b-r-4">
                ...
                <a href="<?php _ec( get_module_url("popup_add_campaign") )?>" class="btn btn-light btn-active-light-primary m-r-1 border-end actionItem" title="<?php _e("Add new")?>" data-toggle="tooltip" data-placement="top" data-popup="addPushCampaign"><i class="fad fa-plus text-primary pe-0"></i></a>
                            ...
                            <thead>
                                <tr class="text-start text-muted fw-bolder text-uppercase gs-0 ">
                                    ...
                                    <?php foreach ( get_data($datatable, "columns") as $key => $value ): ?>
                                        ...
                                        <?php if ( $key == "id" ): ?>
                                        <td scope="col" class="w-20 border-bottom py-4 ps-4">
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input checkbox-all" type="checkbox">
                                            </div>
                                        </td>
                                        <?php else: ?>
                                        <td scope="col" class="border-bottom py-4 pe-4 fw-6 fs-12 text-nowrap text-dark text-nowrap"><?php _e( $value )?></td>
                                        <?php endif ?>
                                    <?php endforeach ?>
                                    <td class="border-bottom py-4 pe-4 w-150"></td>
                                </tr>
                            </thead>
