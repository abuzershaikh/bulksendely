...
// Define routes for Whatsapp_livechat module
$routes->group('', ['namespace' => 'Core\Whatsapp_livechat\Controllers'], static function ($routes) {
    $routes->post('whatsapp_livechat/info', 'Whatsapp_livechat::info');
    $routes->post('whatsapp_livechat/get_messages', 'Whatsapp_livechat::get_messages');
    $routes->post('whatsapp_livechat/send', 'Whatsapp_livechat::send');
    $routes->post('whatsapp_livechat/toggle_status', 'Whatsapp_livechat::toggle_status');
    $routes->post('whatsapp_livechat/get_status', 'Whatsapp_livechat::get_status');
    $routes->post('whatsapp_livechat/get_contacts', 'Whatsapp_livechat::get_contacts');
});
