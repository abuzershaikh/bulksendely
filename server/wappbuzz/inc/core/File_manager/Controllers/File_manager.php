...
class File_manager extends \CodeIgniter\Controller
{
    public function __construct(){
        ...
        $this->extensions = get_option("fm_allow_extensions", "jpeg,gif,png,jpg,mp4,csv,pdf,mp3,webp");
    ...
    public function widget( $params = [] ){
        ...
        return view('Core\File_manager\Views\widget', [ "type" => $type, "select_multi" => $select_multi, "id" => $id, "name" => $name]);
    }
    ...
    public function mini( $params = [] ){
        ...
        return view('Core\File_manager\Views\mini', $data);
    }

    public function select_image( $params = [] ){
        $max_width = "250";
        ...
        return view('Core\File_manager\Views\box_select_image', $data);
    }

    public function popup($type = "", $select = 0, $id = "", $name = "medias") {
