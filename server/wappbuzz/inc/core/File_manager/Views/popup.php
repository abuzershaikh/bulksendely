<div class="modal fade file-manager file-manager-modal" data-select-multi="<?php echo $select?>" data-name="<?php echo $name?>" id="file-manager" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-fullscreen-lg-down modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body shadow-none n-scroll overflow-hidden bg-light-dark fm-list row px-2 py-4 ajax-load-scroll m-l-0 m-r-0 align-content-start" data-url="<?php _e( get_module_url("load_files/widget/".$id."?name=".$name) )?>" data-scroll="ajax-load-scroll" data-call-after="File_manager.lazy();">
