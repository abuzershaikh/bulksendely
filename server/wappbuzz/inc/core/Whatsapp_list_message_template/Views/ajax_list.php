            ...
            <div class="card b-r-10">
                <div class="card-body position-relative p-r-50">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-2">
                            <small class="text-muted"><?php _e('Template ID:') ?> <span class="fw-bold text-dark"><?php _ec($value->ids) ?></span></small>
                        </div>
                    </div>
                    <div class="d-flex">
                        ...
                        <button type="button" class="btn btn-sm btn-dark w-35 h-35 text-center d-flex align-items-center me-2 position-relative copy-template-id" data-template-id="<?php _ec($value->ids) ?>" title="<?php _e('Copy Template ID') ?>" data-toggle="tooltip"><i class="position-absolute l-11 fs-14 fal fa-copy"></i></button>
                    </div>
                </div>
            </div>
        </div>
