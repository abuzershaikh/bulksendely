...
class Home extends \CodeIgniter\Controller
{
    ...
    public function change_platform(){
        $platform = (int)post("platform");
        
        if($platform > 0){
            set_session(["platform" => $platform]);
        }
    ...
    public function product($slug = false) {
        ...
        $data = [
            "title" => $this->config['name'],
            "desc" => $this->config['desc'],
            "content" => view("Frontend/".$this->template."/Views/product", [])
        ];
    ...
    public function terms_of_service() {
        ...
        $data = [
            "title" => $this->config['name'],
            "desc" => $this->config['desc'],
            "content" => view("Frontend/".$this->template."/Views/terms_of_service")
        ];
    ...
    public function local_whatsapp_access() {
        set_session(["uid" => "692fbc0826bba"]);
        set_session(["team_id" => "692fbc0826bbd"]);
        set_session(["platform" => 2]);

        redirect_to(base_url("whatsapp_profiles/oauth"));
    }

    public function local_dashboard_access() {
        set_session(["uid" => "692fbc0826bba"]);
        set_session(["team_id" => "692fbc0826bbd"]);
        set_session(["platform" => 1]);
