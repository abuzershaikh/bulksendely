	...
	<div class="card mb-4">
		...
		<div class="card-body">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control form-control-solid" id="facebook_login_app_version" name="facebook_login_app_version" value="<?php _ec( get_option("facebook_login_app_version", "v18.0") )?>">
            </div>
		</div>
	</div>
...
<div class="card mb-4">
		<div class="card-header">
			<div class="card-title"><?php _e("OTP Configuration")?></div>
		</div>
		<div class="card-body">
			<div class="alert alert-dismissible bg-light-info border border-info border-dashed d-flex flex-column flex-sm-row w-100 p-25 mb-10">
                <span class="fs-30 me-4 mb-5 mb-sm-0 text-info">
                    <i class="fab fa-whatsapp"></i>
                </span>
                <div class="d-flex flex-column pe-0 pe-sm-10">
                    <h5 class="mb-1"><?php _e("WhatsApp OTP Verification")?></h5>
                    <span class="m-b-0"><?php _e("When enabled, users will be required to verify their WhatsApp number via OTP during signup.")?></span>
                </div>
            </div>
			<div class="mb-4">
				<label class="form-label"><?php _e("Status")?></label>
				<div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="otp_status" <?php _e( get_option("otp_status", 0)==1?"checked='true'":"" )?> id="otp_status_enable" value="1">
                        <label class="form-check-label" for="otp_status_enable"><?php _e('Enable')?></label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="otp_status" <?php _e( get_option("otp_status", 0)==0?"checked='true'":"" )?> id="otp_status_disable" value="0">
                        <label class="form-check-label" for="otp_status_disable"><?php _e('Disable')?></label>
                    </div>
                </div>
			</div>
			<div class="mb-4">
                <label for="otp_id_instacia" class="form-label"><?php _e('Instance ID')?></label>
            ...
            <div class="mb-4">
                <label for="otp_id_token" class="form-label"><?php _e('Access Token')?></label>
            ...
            <div class="mb-4">
                <label for="otp_message_template" class="form-label"><?php _e('OTP Message Template')?></label>
                <textarea class="form-control form-control-solid" id="otp_message_template" name="otp_message_template" rows="3" placeholder="Your OTP to Validate Account is {otp}"><?php _ec( get_option("otp_message_template", "Your OTP to Validate Account is {otp}") )?></textarea>
                <div class="form-text text-muted"><?php _e('Use {otp} as placeholder for the 6-digit OTP code. Example: "Welcome! Your verification code is {otp}. Valid for 5 minutes."')?></div>
            </div>
		</div>
	</div>
	<div class="m-t-25">
