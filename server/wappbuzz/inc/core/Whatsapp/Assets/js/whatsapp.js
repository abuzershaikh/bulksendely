...
function Whatsapp(){
    ...
    this.sfix_phone = function(){
        // Check if the send_to input element exists before initializing intlTelInput
        var sendToInput = document.querySelector(".post-schedule input#send_to");
        if (!sendToInput) {
            return; // Element doesn't exist on this page, skip initialization
        }
    ...
    this.set_phone = function(){
        // Check if the phone input element exists before initializing intlTelInput
