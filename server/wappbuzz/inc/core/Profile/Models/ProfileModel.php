...
class ProfileModel extends Model
{
    ...
    public function invoices()
    {
        ...
        $builder->select('a.*,b.name as plan_name,c.username,c.fullname,c.email,c.whatsapp,c.avatar');
    ...
    public function invoice($id)
    {
        ...
        $builder->join(TB_PLANS." as b", "a.plan = b.id", "LEFT");
        $builder->join(TB_USERS." as c", "a.uid = c.id", "LEFT");
        $builder->select('a.*,b.name as plan_name,c.username,c.fullname,c.email,c.whatsapp,c.avatar,b.price_monthly,b.price_annually');
        $builder->where('a.uid', $user_id);
