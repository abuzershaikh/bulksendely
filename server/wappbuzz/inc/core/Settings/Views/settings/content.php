<div class="container my-5">
    <div class="card card-flush">
        ...
        <div class="card-body">
            ...
            <div class="mb-4">
                <label for="website_copyright" class="form-label"><?php _e('Website Copyright')?></label>
                <input type="text" class="form-control form-control-solid" id="website_copyright" name="website_copyright" value="<?php _ec( get_option("website_copyright", '© 2025-26 <a href="https://mqtechguru.com/" target="_blank" class="text-decoration-none">MQ TECH GURU</a> All Rights Reserved') )?>">
                <div class="form-text text-muted"><?php _e('Supports HTML. Example: © 2025 &lt;a href="https://yoursite.com"&gt;Your Company&lt;/a&gt; All Rights Reserved')?></div>
            </div>
            <div class="mb-4">
