...
function Layout(){
            ...
            if( $(this).next('.menu-sub').length > 0 ){
                ...
                if( menu_sub.length > 0 ){
                    if( menu_sub.hasClass('show') ){
                        ...
                        nav_item.removeClass('menu-open');
                    }else{
    ...
    this.scroll = function(){
        // Disabled JS-based horizontal scroll hijacking.
        // Native scrolling is hardware accelerated and smoother on all modern devices.
        /*
        $('.nx-scroll,.overflow-x-auto,.overflow-x-scroll').delyntro_no_scroll(function(e, delta) {
