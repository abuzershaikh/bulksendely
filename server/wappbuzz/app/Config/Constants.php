...
defined('COREPATH') || define('COREPATH', ROOTPATH . 'inc/core/');
defined('PLUGINPATH') || define('PLUGINPATH', ROOTPATH . 'inc/plugins/');
defined('THEMEPATH') || define('THEMEPATH', ROOTPATH . 'inc/themes/');
